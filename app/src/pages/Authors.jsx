...
const Authors = () => (
  <article className="w-75 center ph3 pv5">
    <div className="flex">
      <Image />
      <Details />
    </div>
...
const Details = () => (
  <header className=" w-50-ns pl4-ns">
...
const Description = () => (
  <div className="dib w-25-ns pr4-ns">
